...
{\tt test\_HedgingMultimonde.te} : Permet de tester la couverture du produit sur un marché simulé (le test du modèle utilisé sera fait avec un back test mis en place pour la prochaine version). 
\begin{center}
\begin{tabular}{c}
\includegraphics[scale=0.3]{pnl} \\
